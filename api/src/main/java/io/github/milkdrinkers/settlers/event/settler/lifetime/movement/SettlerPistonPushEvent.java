...
public class SettlerPistonPushEvent extends AbstractSettlerEvent implements Cancellable { // TODO Mirror citizens event
    public DespawnReason spawnReason;
    private boolean cancelled;

    protected SettlerPistonPushEvent(Settler settler, DespawnReason spawnReason) {
        super(settler);
