...
public class SettlerLookRetargetEvent extends AbstractSettlerEvent implements Cancellable { // TODO Mirror citizens event
    public DespawnReason spawnReason;
    private boolean cancelled;

    protected SettlerLookRetargetEvent(Settler settler, DespawnReason spawnReason) {
        super(settler);
