...
public class SettlerDamageByEntityEvent extends AbstractSettlerEvent implements Cancellable { // TODO Mirror citizens event
    public DespawnReason spawnReason;
    private boolean cancelled;

    protected SettlerDamageByEntityEvent(Settler settler, DespawnReason spawnReason) {
        super(settler);
