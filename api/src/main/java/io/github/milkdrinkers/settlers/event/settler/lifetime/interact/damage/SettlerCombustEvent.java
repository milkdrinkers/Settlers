...
public class SettlerCombustEvent extends AbstractSettlerEvent implements Cancellable { // TODO Mirror citizens event
    public DespawnReason spawnReason;
    private boolean cancelled;

    protected SettlerCombustEvent(Settler settler, DespawnReason spawnReason) {
        super(settler);
