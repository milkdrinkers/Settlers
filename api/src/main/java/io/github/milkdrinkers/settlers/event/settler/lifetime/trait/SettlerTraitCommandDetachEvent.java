...
public class SettlerTraitCommandDetachEvent extends AbstractSettlerEvent implements Cancellable { // TODO Mirror citizens event
    private final ClickType clickType;
    private final Player clicker;
    private boolean cancelled;

    public SettlerTraitCommandDetachEvent(Settler settler, ClickType clickType, Player clicker) {
        super(settler);
